...
<p>&nbsp;</p>
	...
	<div style="width: 580px;"><input name="rContent" value="" size="20" /> &nbsp;&nbsp;
...
<div>当前页面是第${pageIndex }页，每页${pageSize } 条记录，共计${pageCount } 条记录  ，共计${pageTotal } 页 &nbsp;
	 <a href="rzhi.jsp?pageIndex=1&rContent=${rContent }">首 &nbsp;页</a>&nbsp;
	 <a href="rzhi.jsp?pageIndex=${(pageIndex-1) }&rContent=${rContent }">上一页</a>&nbsp; 
	 <a href="rzhi.jsp?pageIndex=${(pageIndex+1) }&rContent=${rContent }">下一页</a>&nbsp;
	 <a href="rzhi.jsp?pageIndex=${pageTotal }&rContent=${rContent }">最后一页</a>
 </div>
</div>
