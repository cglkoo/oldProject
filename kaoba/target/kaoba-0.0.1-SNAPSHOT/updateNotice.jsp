...
sql=" update t_notice set nName=? , nContent=? , nDate=? where nId=? ";
...
通告标题：&nbsp;&nbsp;<input name="nName"  value="<%=name %>"  size="50" /> &nbsp;&nbsp;
<br/><br/>
通告内容：&nbsp;&nbsp; <textarea  rows="5" name="nContent" cols="50"><%=content %></textarea> &nbsp;&nbsp;
