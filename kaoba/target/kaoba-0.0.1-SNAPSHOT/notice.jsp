<%@ page language="java" import="com.kaokaoba.notice.*,java.util.*" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
...
<div style="width: 580px;">通告标题：&nbsp;&nbsp;<input name="nName"   size="20" /> &nbsp;&nbsp;<button id="b1">
&nbsp;&nbsp;关&nbsp;&nbsp;键&nbsp;&nbsp;字&nbsp;&nbsp;查&nbsp;&nbsp;询&nbsp;&nbsp;</button>
...
&nbsp;&nbsp;添&nbsp;&nbsp;加&nbsp;&nbsp;通&nbsp;&nbsp;告&nbsp;&nbsp;</button>
 ...
 <p>&nbsp;</p>
<table>
<tr><th>序号</th><th>通告标题</th> <th>操作</th></tr>
...
%>
<tr><td><%=(i+1) %></td><td><%=u.getnName() %></td> 
<td>&nbsp;&nbsp;<a href="updateNotice.jsp?nId=<%=u.getnId() %>">&nbsp;修&nbsp;改&nbsp;</a>&nbsp;&nbsp;

<a href="deleteNotice.jsp?nId=<%=u.getnId() %>">&nbsp;删&nbsp;除&nbsp;</a></td></tr>
...
<div>当前页面:第<%=pageIndex %>页，每页<%=pageSize %>条记录，共计<%=pageCount %>条记录  ，共计<%=pageTotal %>页
 <a href="notice.jsp?pageIndex=1&nName=<%=nName %>">&nbsp;&nbsp;首页</a> &nbsp;
