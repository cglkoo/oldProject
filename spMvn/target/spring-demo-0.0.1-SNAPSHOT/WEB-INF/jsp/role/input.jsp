	...
	<div class="row" style="margin-top:100px;">
		...
		<div class="col-md-6">
		 <input  type="hidden" name="rId" value="${rId }"/>
			 <form action="add" class="form form-horizontal" method="post" onsubmit="return onSubmit()">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" value="${rName }" class="form-control" id="rName" name="rName" onblur='checkName()' >
					</div>
...
function checkName(){
	...
	if(v!=""||v.length>0){
		$.ajax({
			type:"POST",
			url:"${rc.getContextPath() }/role/checkName",
			data:{"roleName":v},
			dataType:"json",
