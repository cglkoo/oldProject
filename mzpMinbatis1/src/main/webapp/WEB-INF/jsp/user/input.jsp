...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<form action="${rc.getContextPath() }/user/add" class="form form-horizontal" method="post"  onsubmit="return onSubmit()" >
					<input type="hidden" id="uIcon" name="uIcon" value="${user.uIcon }">
					...
					<div class="form-group">
						...
						<div class="col-sm-8"><input type="text" class="form-control" id="uName" value="${user.uName }" name="uName"></div>
					</div>
					<div class="form-group">
						<div class="col-sm-2"><label class="control-label">密码</label></div>
						<div class="col-sm-8"><input type="text" class="form-control" id="uPwd"  value="${user.uPwd }" name="uPwd"></div>
					</div>
					<div class="form-group">
