...
<body>
<div class="row">
	<input type="hidden" name="pageIndex" id="pageNo" value="${page.pageNo }">
	<div class="col-sm-6">
		...
		<nav aria-label="Page navigation">
		  ...
		  <!-- 计算上一页的页码 -->
		    ...
		    <c:forEach begin="${startNo }" end="${endNo }" varStatus="s">
		    	<li <c:if test="${page.pageNo eq s.index }">class="active"</c:if> ><a href="#" onclick="goToPage(${s.index})">${s.index }</a></li>
		    </c:forEach>
