	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div style="margin-top: 30px;">
				...
				每页显示 <select name="pageSize" onchange="pageSizeChange()">
		...
		<div class="col-sm-6">
			<nav aria-label="Page navigation">
				<ul class="pagination">
					...
					<li><a href="#" onclick="goToPage(${prePage})"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
					</a></li>

					<!-- 计算循环的起始位置和结束位置 -->
					<fmt:parseNumber var="rowNo" value="${page.pageNo / 5  }"
						integerOnly="true" />
					...
					<c:forEach begin="${startNo }" end="${endNo }" varStatus="s">
						<li <c:if test="${page.pageNo eq s.index }">class="active"</c:if>><a
							href="#" onclick="goToPage(${s.index})">${s.index }</a></li>
					</c:forEach>
					...
					<li><a href="#" onclick="goToPage(${nextPage})"
