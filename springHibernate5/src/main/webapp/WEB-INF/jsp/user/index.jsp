			...
			<div class="row">
				<div class="col-sm-3">
					<input type="text" name="userName" class="form-control"
						value="${userName }" placeholder="按用户名称搜索"> <input
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table table-striped table-hover">
						<thead>
							<tr>
								<th width="10%">全选 <input type="checkbox" id="all"
									name="all" /></th>
								<th width="10%">序号</th>
								<th width="30%">用户名</th>
								<th width="30%">用户头像</th>
							...
							<c:forEach items="${userList }" var="user" varStatus="s">
								<tr id="${user.uId}">
									...
									<td><img src="${user.userIcon }" id="${user.userIcon }"
										...
										height="100px" /></td>
									<td><a href="getUser.action?userId=${user.uId }"
										role="button" class="btn btn-info">修改</a> <a href="#"
