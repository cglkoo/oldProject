...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<form action="addUser.action" class="form form-horizontal"
					method="post" onsubmit="return onSubmit()">
					<input type="hidden" id="userIcon" name="userIcon"
						value="${user.userIcon }"> <input type="hidden" id="uId"
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="pwd"
								value="${user.userPwd }" name="userPwd">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select multiple="multiple" class="form-control" id="role"
								name="userRole">
