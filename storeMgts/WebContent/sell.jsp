...
<body>
	...
	<div align="center">
		...
		<form id="myForm" method="post" action="sell.jsp">
			<div style="width: 600px;">
				手机型号：&nbsp;<input name="mTypes" size="20" /> &nbsp;&nbsp;
	...
	%>
			<tr>
				...
				<td><a href="updateSell.jsp?mId=<%=u.getmId() %>">修&nbsp;改</a>&nbsp;
					<a href="deleteSell.jsp?mId=<%=u.getmId() %>">删&nbsp;除</a></td>
			</tr>
			<%
	}
	}
	%>
		...
		<div>
			...
			&nbsp; <a
				href="sell.jsp?pageIndex=<%=(pageIndex-1) %>&mTypes=<%=mTypes %>">上一页</a>
			&nbsp;<a
				href="sell.jsp?pageIndex=<%=(pageIndex+1) %>&mTypes=<%=mTypes %>">下一页</a>
			&nbsp; <a
				href="sell.jsp?pageIndex=<%=pageTotal %>&mTypes=<%=mTypes %>">最后一页</a>
		</div>
	</div>
