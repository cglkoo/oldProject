<%@ page language="java" import="com.store.elscore.*,java.util.*"
...
<body>
	<div align="center">
		...
		<form action="elscores.jsp" name="roleForm" method="post">
			<div style="width: 580px;">
				姓名：&nbsp;&nbsp;<input name="userName" size="30" /> &nbsp;&nbsp;
				<button>
					&nbsp;&nbsp;关&nbsp;&nbsp;键&nbsp;&nbsp;字&nbsp;&nbsp;查&nbsp;&nbsp;询&nbsp;&nbsp;</button>
			</div>
		</form>
	...
	%>
		...
		<div>
			...
			<a
				href="elscores.jsp?pageIndex=<%=(pageIndex-1) %>&userName=<%=userName %>">上一页</a>&nbsp;
			<a
				href="elscores.jsp?pageIndex=<%=(pageIndex+1) %>&userName=<%=userName %>">下一页</a>&nbsp;
			<a
				href="elscores.jsp?pageIndex=<%=pageTotal %>&userName=<%=userName %>">最后一页</a>
		</div>
	</div>
